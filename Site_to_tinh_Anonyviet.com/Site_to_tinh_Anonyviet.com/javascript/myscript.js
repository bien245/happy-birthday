...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "nhấn vào đây để nhận"+" "+ (thePercent+899)+" "+ "lời chúc nhé" ;
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;chúc bạn';
document.querySelector('.Description .modal-body').innerHTML = 'có thật nhiều lời chúc sinh nhật trong hôm nay <i class="fas fa-heart"></i> ';
